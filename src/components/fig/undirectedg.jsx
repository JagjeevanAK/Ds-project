...
function Graph() {
  ...
  useEffect(() => {
    ...
    // Define nodes with different positions
    const nodes = [
      { id: "Node 1", x: 100, y: 100 },
      { id: "Node 2", x: 300, y: 100 },
      { id: "Node 3", x: 500, y: 100 },
      { id: "Node 4", x: 100, y: 300 },
      { id: "Node 5", x: 300, y: 300 },
      { id: "Node 6", x: 500, y: 300 },
      { id: "Node 7", x: 200, y: 200 },
      { id: "Node 8", x: 400, y: 200 },
    ];

    // Define bidirectional (undirected) links between nodes
    const links = [
